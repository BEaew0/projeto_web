...
export default function Menu() {
  ...
  return (
    <div className="menu__">
      ...
      <div className="itens_esquerda">
        <LogoTS link={"/"} logo={Logo_ts} className="header_logo"></LogoTS>
        {links_esquerda.map((link, key) => (
          <Menu_header key={key} link={link.link} text={link.text} />
        ))}
        </div>

      <div className="itens_direita">
