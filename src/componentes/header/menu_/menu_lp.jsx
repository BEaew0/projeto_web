//importando componentes no REACT
...
//links na esquerda no header seus links
...
//links na direita no header e seus links
const links_direita =[
...
//vai checar se o usuário está logado para então modificar os itens no header
